...
$(document).ready(function () {
    ...
    $('#btnExportarPdf').on('click', function () {
        ...
        var url = '/EquiposRentados/EquipoRentados/ExportarPdf?search=' + encodeURIComponent(searchText);
...
function cargarDatatable() {
    dataTable = $("#tblRentados").DataTable({
        scrollX: true, // Scroll horizontal para muchas columnas

        ajax: {
            url: "/EquiposRentados/EquipoRentados/GetAll", // Endpoint que devuelve JSON { data: [...] }
            type: "GET",
            datatype: "json"
        },
